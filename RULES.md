...
The final evaluation score is calculated using the following criteria:

| Evaluation Area | Marks | Target Metric / Criteria |
|-----------------|-------|--------------------------|
| Model Logits MSE | 25 | MSE on intermediate classification logits |
| Reconstruction Quality | 25 | Correct layer pairing and sequential reassembly |
| Runtime & Efficiency | 10 | Speed and computational footprint of the solver |
| Technical Explanation | 10 | Mathematical depth and clarity in the report |
| Methodology & Innovation | 8 | Rigor and uniqueness of the pairing and search strategies |
| Experimental Analysis | 6 | Quality of testing, parameter logs, and performance curves |
| Presentation & Clarity | 4 | Document structure and readability |
| Reproducibility | 2 | Cleanliness of configuration guides and scripts |
| **TOTAL** | **90** | |
